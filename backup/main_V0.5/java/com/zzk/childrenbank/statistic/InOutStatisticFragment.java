...
public class InOutStatisticFragment extends PeriodFragment {
    ...
    public InOutStatisticFragment(Child child) {
        super(child);
    }
    ...
    public static InOutStatisticFragment newInstance(Child child) {
        InOutStatisticFragment fragment = new InOutStatisticFragment(child);
