package com.zzk.childrenbank.automation;
...
import com.zzk.childrenbank.data.Automation;
...
import com.zzk.childrenbank.statistic.DropdownList;
import com.zzk.childrenbank.transactions.CategoryManagementActivity;
import com.zzk.childrenbank.transactions.FromToManagementActivity;
...
public class AutomationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dropdownListAccount1Child = findViewById(R.id.dropdownList_automation_account1_child);
        ...
        dropdownListAccount2Child = findViewById(R.id.dropdownList_automation_account2_child);
        ...
        fillChildItems(dropdownListAccount1Child);
        dropdownListAccount1Child.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                int pos = dropdownListAccount1Child.getSelectedItemPosition();
                Child child = dataModel.childList.get(pos);
                fillAccountItems(dropdownListAccount1, child);
            }
        ...
        dropdownListAccount1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Account account = child.accountList.get(pos);
        ...
        fillChildItems(dropdownListAccount2Child);
        dropdownListAccount2Child.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                int pos = dropdownListAccount2Child.getSelectedItemPosition();
                Child child = dataModel.childList.get(pos);
                fillAccountItems(dropdownListAccount2, child);
            }
        ...
        if(automationId>=0) {       //  修改
            ...
            Child child = dataModel.findChildByAccount(originAutomation.account1);
            dropdownListAccount1Child.setSelectedItem(child.name);
            fillAccountItems(dropdownListAccount1, child);
            Account account = child.findAccountById(originAutomation.account1);
            ...
            child = dataModel.findChildByAccount(originAutomation.account2);
            dropdownListAccount2Child.setSelectedItem(child.name);
            fillAccountItems(dropdownListAccount2, child);
            account = child.findAccountById(originAutomation.account2);
    ...
    void fillChildItems(DropdownList dropdownList) {
        dropdownList.clearItem();
        Iterator<Child> iter = dataModel.childList.iterator();
        while(iter.hasNext()) {
            Child child = iter.next();
            dropdownList.addItem(child.name);
        }
        dropdownList.updateData();
    }

    void fillAccountItems(DropdownList dropdownList, Child child) {
        dropdownList.clearItem();
        if(child==null) {
            dropdownList.updateData();
            return;
    ...
    boolean validate() {
        ...
        int childPos = dropdownListAccount1Child.getSelectedItemPosition();
        Child child = dataModel.childList.get(childPos);
        int accountPos = dropdownListAccount1.getSelectedItemPosition();
        Account account = child.accountList.get(accountPos);
        ...
        childPos = dropdownListAccount2Child.getSelectedItemPosition();
        child = dataModel.childList.get(childPos);
        accountPos = dropdownListAccount2.getSelectedItemPosition();
        account = child.accountList.get(accountPos);
        automation.account2 = account.id;
        categoryPos = dropdownListAccount2Category.getSelectedItemPosition();
        category = account.categoryList.get(categoryPos);
        automation.account2Category = category.id;
        fromtoPos = dropdownListAccount2FromTo.getSelectedItemPosition();
        fromTo = dataModel.fromList.get(fromtoPos);
