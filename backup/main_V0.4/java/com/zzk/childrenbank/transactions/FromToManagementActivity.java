...
/*
        ...
        if(fromToFlag ==1) {
            ...
            fromToAdapter.setFromToList(dataModel.fromList);
        } else {
            textViewFromTo.setText("去向");
            fromToAdapter.setFromToList(dataModel.toList);
        }
*/
        fromToAdapter = new FromToAdapter(2);
        fromToAdapter.setFromToList(dataModel.fromToList);
