...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + tableNameTransaction +
                "(_id INTEGER PRIMARY KEY AUTOINCREMENT, child TINYINT, account TINYINT, amount INT, after_balance INT, category SMALLINT, fromto SMALLINT, date LONG, notes VERCHAR(255))");
