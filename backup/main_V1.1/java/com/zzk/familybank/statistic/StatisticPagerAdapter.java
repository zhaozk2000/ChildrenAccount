...
class StatisticPagerAdapter extends FragmentPagerAdapter {
    ...
    public StatisticPagerAdapter(Context context, PeriodSelectFragment periodSelectFragment, Holder holder, FragmentManager fm) {
        super(fm);
        mContext = context;
    ...
    public Fragment getItem(int position) {
        ...
        switch (position){
            case 0:
                fragment = InOutStatisticFragment.newInstance(holder);
                break;
            case 1:
                fragment = CategoryStatisticFragment.newInstance(holder);
                break;
            case 2:
                fragment = SrcDestStatisticFragment.newInstance(holder);
                break;
        }
