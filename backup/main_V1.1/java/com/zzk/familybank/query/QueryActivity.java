...
import com.zzk.familybank.MainActivity;
...
public class QueryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonQuery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transactions = DAO.queryTransaction(whereString);

                //  数据项填充到表格
                int sum = fillDataToTable();
        ...
        tableFragment.setCellOnClickListener(new TableCellOnClickListener() {
            ...
            public void onClick(int x, int y, String content) {
                //Toast.makeText(QueryActivity.this, "("+x + "," + y + ")", Toast.LENGTH_SHORT).show();
                if(transactions==null || y<1) return;
                Transaction transaction = transactions.get(y-1);
                Intent intent = new Intent(QueryActivity.this, TransactionActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent){
        if(requestCode==1 && resultCode==1) {   // Operation success
            transactions = DAO.queryTransaction(whereString);
            fillDataToTable();
        }
        setResult(1);
