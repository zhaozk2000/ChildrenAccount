package com.zzk.familybank.tablescroll2d;
...
public class TableScroll2dFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tableContentAdapter.setColumnWidth(columnWidth);
        tableContentAdapter.setFirstColumnWidth(firstColumnWidth);

        tableTopAdapter.setCellOnClickListener(cellOnClickListener);
        tableContentAdapter.setCellOnClickListener(cellOnClickListener);
    ...
    public void setCellOnClickListener(TableCellOnClickListener listener) {
        ...
        if(tableContentAdapter!=null)
            tableContentAdapter.setCellOnClickListener(listener);
