...
public class CategoryStatisticFragment extends PeriodFragment {
    ...
    public CategoryStatisticFragment(Holder holder) {
        super(holder);
    }
    ...
    public static CategoryStatisticFragment newInstance(Holder holder) {
        CategoryStatisticFragment fragment = new CategoryStatisticFragment(holder);
    ...
    void prepareData(){
        List<Category> categories = holder.getCategoryList();
