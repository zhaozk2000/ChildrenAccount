...
public class SrcDestStatisticFragment extends PeriodFragment {
    ...
    public SrcDestStatisticFragment(Holder holder) {
        super(holder);
    }
    ...
    public static SrcDestStatisticFragment newInstance(Holder holder) {
        SrcDestStatisticFragment fragment = new SrcDestStatisticFragment(holder);
    ...
    void prepareData(){
        ...
        List<FromTo> fromToList = dataModel.getFromToList(3);
